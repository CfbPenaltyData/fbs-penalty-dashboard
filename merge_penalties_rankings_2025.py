...
# merge conference from teams_lookup using canonical name
off = off.merge(teams_lookup, how="left", left_on="team_canonical", right_on="school_canonical")
# now merge rankings on canonical school
off = off.merge(rankings_pivot, how="left", left_on="team_canonical", right_on="school_canonical")
